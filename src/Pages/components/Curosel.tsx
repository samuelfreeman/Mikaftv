...
export default function ImageSlider() {
  ...
  return (
    <div className="w-full min-h-[43vh] max-h-[90vh] md:min-h-[80vh] mx-auto px-4 border pt-10 ">
      <Carousel
        setApi={setApi}
        opts={{
          align: "center",
      ...
      >
        <CarouselContent>
          {images.map((src, index) => (
            <CarouselItem key={index} className=" basis-1/2   md:basis-1/2 lg:basis-1/5 transition-all duration-300">
              <div
                className={cn(
