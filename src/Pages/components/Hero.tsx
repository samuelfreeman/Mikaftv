...
const Hero = () => {
    return (
        <div className='mb-10 mt-24 md:mt-28   m-7 flex flex-col md:flex-row justify-between '>
            ...
            <div className=' w-full md:w-5/12 m-5 -ml-1 md:m-14 md:mt-[16px]'>
            ...
            <div className=" flex flex-col mx-2  p-1 md:p-2 w-[200px] h-[100px]  rounded-md border  md:block md:relative md:w-[550px] md:h-[300px] ')] md:bg-cover md:mr-20  md:rounded-lg">
