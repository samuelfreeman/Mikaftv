...
const Location = () => {
  return (
     ...
     <div className="w-full mt-10   min-h-[70vh]  md:min-h-[120vh]    md:max-h-[80vh] md:mt-0 ">
    ...
    <div className=" flex justify-center flex-col items-center">
        ...
        <div className=" border-4 md:w-full w-11/12   border-[#24918D]">
    ...
    <iframe
      ...
      className="md:w-full    h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] rounded-lg shadow-lg"
      style={{ border: "0" }}
      allowFullScreen
      loading="lazy"
