...
const Controls: React.FC<ButtonControlsProps> = ({ onCategoryChange, selectedCategory }) => {
    ...
    return (
        <div className="w-full md:flex md:justify-between md:pb-3 mb-36 mt-14 top-0 left-0 right-0 z-10 fixed bg-white border-b">
            ...
            <div className="m-4 flex flex-col sm:flex-row sm:items-center sm:justify-end sm:space-x-2 sm:mr-20">
